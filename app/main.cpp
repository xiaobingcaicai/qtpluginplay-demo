...
int main(int argc, char *argv[])
{
    ...
    pluginsDir.cd("customPlugin/QCommonPlugins");
    QPluginLoader *senderPlugin = new QPluginLoader(pluginsDir.absoluteFilePath("basicsender.dll"), qApp);
    bool loaded = senderPlugin->load();
    QPluginLoader *receiverPlugin = new QPluginLoader(pluginsDir.absoluteFilePath("basicreceiver.dll"), qApp);
